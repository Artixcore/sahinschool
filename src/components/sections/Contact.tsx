        ...
        <div className="mt-12 grid gap-10 lg:grid-cols-2 lg:items-start">
          <Reveal delay={0.05}>
            <div className="space-y-6 rounded-3xl border border-sky-100 bg-sky-50/40 p-6 shadow-inner sm:p-8">
              ...
              <div className="overflow-hidden rounded-2xl border border-dashed border-sky-200 bg-white/80">
                <div className="flex min-h-[220px] flex-col items-center justify-center gap-2 p-6 text-center">
                  <MapPin className="h-10 w-10 text-sky-400" aria-hidden />
                  <p className="text-sm font-semibold text-neutral-700">
                    Map location will be updated soon
                  </p>
                </div>
              </div>
            </div>
